...
## rodar as migrate
> php artisan migrate
## verificar as rotas da aplicação
...
opção 12
## Notificação e-mail
vai ser criado dentro da pasta app o diretório Notifications
> php artisan make:notification RedefinirSenhaNotification
> php artisan make:notification VerificarEmailNotification
## Páginas de erros do projeto:
\vendor\laravel\framework\src\Illuminate\Foundation\Excpetions\views
## Senha
Pcfo*1234
## Configurações banco de dados 000webhost
- Nome: ct
        id21862240_ct
...
- Senha: Laravel*1234
## Observações
- colocar os resultados próximos ao nome do aluno
